...
namespace SuperTank
{
    public class SocketClient
    {
        ...
        public static void SendPlayerPosition(string playerName, Direction direction, int X, int Y)
        {
            // Gửi giá trị int của Direction thay vì string
            string message = $"UPDATE_POSITION;{playerName};{(int)direction};{X / Common.STEP};{Y / Common.STEP}";
            SendData(message);
        }
